...
def train():                                        
    ...
    model.model_save_dir = os.path.join(base_dir,'trained_models/product')                         
    model.model_save_file_name='product_model'
    model.train_csv_file = os.path.join(base_dir,'data/trainning_data.csv')
    model.name_id_mapping_file = os.path.join(base_dir,'product_name_id_map.csv')
    ...
    model.LoadData(dataloader = DataUtil.LoadProductData)
    model.TrainModel()
