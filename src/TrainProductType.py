...
def train():                                        
    ...
    model.model_save_dir = os.path.join(base_dir,'trained_models/producttype')                         
    model.model_save_file_name='producttype_model'
    model.train_csv_file = os.path.join(base_dir,'data/trainning_data.csv')
    model.name_id_mapping_file = os.path.join(base_dir,'producttype_name_id_map.csv')
    ...
    model.LoadData(dataloader = DataUtil.LoadProductTypeData)
    model.TrainModel()
